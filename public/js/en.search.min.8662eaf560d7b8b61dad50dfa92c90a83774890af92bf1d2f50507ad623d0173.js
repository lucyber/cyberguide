...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/js/groupBy-b74d94583e.min.js');loadScript('/js/flexsearch-8cd742385b.min.js',function(){const indexCfg={};const dataUrl="/en.search-data.min.json"
